...
#Option 1
numericVars <- panelnoGEOM %>% dplyr::select(is.numeric) %>%

#Option 2
corrplot_num <- panelnoGEOM %>% 
  select(lag2Hours, Precipitation, Visibility, Delay4_numeric) %>% na.omit(na.action = "omit")
...
panelnoGEOMTrain <- filter(panelnoGEOM, week < 6) 
...
Model1 <- lm(mean_delay ~ Temperature + Precipitation + lag2Hours + lag3Hours + lag4Hours + lag12Hours + lag1day + lag1week + onestoplag + onestopearlieron + twostoplag + Delay4_numeric,  data=panelnoGEOM)

stargazer(Model1, type="text", title="Regression Results", font.size = "small", single.row = TRUE)


Model2 <- lm(mean_delay ~ Temperature + Precipitation + lag2Hours + lag3Hours + lag4Hours + lag12Hours + lag1day + lag1week + onestoplag + onestopearlieron + twostoplag,  data=panelnoGEOM)

stargazer(Model2, type="text", title="Regression Results", font.size = "small", single.row = TRUE)


#Giving 0 because Delay4_numeric has all 0. Look at line 794
Model3 <- glm(Delay4_numeric ~ Temperature + Precipitation + lag2Hours + lag3Hours + lag4Hours + lag12Hours + lag1day + lag1week + onestoplag + onestopearlieron + twostoplag,  data=panelnoGEOM)
