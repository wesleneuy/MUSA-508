...
tracts2009 <-  
  ...
  mutate(pctBachelors = ifelse(TotalPop > 0,((FemaleBachelors + MaleBachelors)/ TotalPop),0),year = "2009") %>%
    select(-FemaleBachelors, -MaleBachelors) 

#Year 2019 Tracts
#Add new variable 
tracts2019 <- 
  get_acs(geography = "tract", variables = c("B25026_001","B19013_001E","B25058_001E","B06009_005E","B03003_003E","B03003_003E"),
                year=2019, state=25, county=025, geometry=T) %>% 
  st_transform('ESRI:102286')%>%
