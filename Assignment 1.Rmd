...
tracts2019 <- 
  ...
  mutate(pctBachelors = ifelse(TotalPop > 0, ((Bachelors) / TotalPop),0),
         pctHispanic = ifelse(TotalPop > 0, Hispanic / TotalPop,0),
         year = "2019") %>%
...
ggplot() +
  ...
  labs(
    ...
    #subtitle = "Real Dollar, The black boarders denote areas close to subway stations.",
    #caption=
    ) +
