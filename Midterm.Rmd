...
The libraries, directory and functions in the code block are needed for this model:
...
|  |-----| https://www.bouldercounty.org/government/open-data/ | geojson | MUSA-508/Midterm |
...
### Linear Regressions for determining correlation strength 
...
corrplot <- st_drop_geometry(boulder.sf) %>% 
  select(price, TotalBathrooms, Size, TotalBedrooms, GarageSize, MedHHInc, TotalPop, parks_nn1, trails_nn1, schools_nn1, healthcare_nn1, restaurant_nn1,starts_with(c("university","marijuanaestablishments"))) %>% na.omit(na.action = "omit")
