...
housingData <-
  st_join(housingData, floodzones) 

housingData$floodzone =
  ifelse(is.na(housingData$floodzone),0, 1)
...
housingData <-
  st_join(housingData, sceniccorridor) 

housingData$sceniccorridor =
  ifelse(is.na(housingData$sceniccorridor),0, 1)
...
housingData <-
  st_join(housingData, wildfires) 

housingData$wildfires =
  ifelse(is.na(housingData$wildfires),0, 1)

#geohazards
housingData <-
  st_join(housingData, geohazards)
```
